 ...
 *   5. Click Publish
 *
 * UPDATE (SEO, May 2026): A content zone was added between the hero and the
 * "What You Get" grid. It renders the page's WordPress editor content via
 * the_content(), so the page now carries real on-page copy that Rank Math can
 * score (previously the page was 100% template HTML and scored as empty). The
 * editor content for this page has been populated in WordPress; deploying this
 * file makes that copy visible on the front end. No SRJ_VERSION bump is needed
 * (styles here are inline, not an enqueued asset), but flush the GoDaddy page
 * cache after deploying so the new section appears.
 *
...
/* ============================================
   Intro / Lead  (editor-managed content)
   Rendered from the page's editor content via the_content()
   so on-page copy is managed in WordPress, not hardcoded here.
   ============================================ */
.srj-newsletter__intro {
    padding: 80px 0 8px;
    background: var(--srj-white);
}
.srj-newsletter__intro-content {
    max-width: 760px;
}
.srj-newsletter__intro-content h2 {
    font-family: 'Lora', Georgia, serif;
    font-weight: 600;
...
.srj-newsletter__intro-content h3 {
    font-family: 'Lora', Georgia, serif;
    font-weight: 600;
...
.srj-newsletter__intro-content p {
    font-family: 'Poppins', sans-serif;
    font-weight: 400;
    font-size: 18px;
    line-height: 1.65;
...
.srj-newsletter__intro-content a {
    color: var(--srj-orange);
    text-decoration: underline;
    text-underline-offset: 2px;
    font-weight: 500;
}
.srj-newsletter__intro-content a:hover { color: var(--srj-navy); }
.srj-newsletter__intro-content .wp-block-image { margin: 28px 0; }
.srj-newsletter__intro-content img { border-radius: 6px; }
...
@media (max-width: 768px) {
    ...
    .srj-newsletter__intro { padding: 48px 0 0; }
    .srj-newsletter__intro-content p { font-size: 16px; }
...
<main class="srj-newsletter" role="main">
    ...
    <!-- ============================================
         Intro / Lead  (editor-managed content)
         Pulls the page's WordPress editor content so the on-page
         narrative and SEO copy live in the page, not in this template.
         ============================================ -->
    <section class="srj-newsletter__intro">
        <div class="srj-newsletter__container">
            <div class="srj-newsletter__intro-content">
        ...
        <div class="srj-newsletter__container">
            <div class="srj-newsletter__author-inner">
                ...
                <div class="srj-newsletter__author-body">
                    ...
                    <p>His three-decade career spans senior security and operations leadership at Citi, Intel, McAfee, and Optiv. He is the author of <em>The AI Business Enablement Audit</em>, Book 01 of the nine-book Operating Discipline for AI canon, and is based in Frisco, Texas.</p>
                </div>
            </div>
        </div>
    </section>
